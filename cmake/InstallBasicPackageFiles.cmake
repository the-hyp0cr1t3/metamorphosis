  ...
  if(_generate_file)
    ...
    if(NOT _IBPF_NO_COMPATIBILITY_VARS)
      ...
      elseif(DEFINED ${_IBPF_VARS_PREFIX}_BUILD_INCLUDE_DIR OR
        ...
        foreach(_target ${_targets})
          if(NOT _get_include_dir)
            set(_get_include_dir "")
          endif()
...
")
  ...
  if(NOT _build_path_vars_suffix)
    set(_build_path_vars_suffix "")
  endif()
  ...
  endforeach()
  if(NOT _build_path_vars)
    set(_build_path_vars "")
  endif()
  ...
  if(NOT _install_path_vars_suffix)
    set(_install_path_vars_suffix "")
  endif()
  ...
  endforeach()
  if(NOT _install_path_vars)
    set(_install_path_vars "")
  endif()
  configure_package_config_file("${_config_cmake_in}"
